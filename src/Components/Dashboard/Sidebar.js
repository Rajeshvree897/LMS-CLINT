        ...
        <ul className="sidebar-nav" id="sidebar-nav">
          ...
          <li className="nav-item">
            <a className="nav-link collapsed" data-bs-target="#components-nav" data-bs-toggle="collapse" href="#">
              <i className="bi bi-menu-button-wide"></i><span>Course</span><i className="bi bi-chevron-down ms-auto"></i>
            </a>
            <ul id="components-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
              <li>
                <a href="/all-course">
                  <i className="bi bi-circle"></i><span>All Courses</span>
                </a>
              </li>
              <li>
                <a href="components-accordion.html">
                  <i className="bi bi-circle"></i><span>Add Course</span>
                </a>
              </li>
              <li>
                <a href="components-badges.html">
                  <i className="bi bi-circle"></i><span>My Course</span>
                </a>
              </li>
              <li>
          ...
          <li className="nav-item">
            ...
            <ul id="forms-nav" className="nav-content collapse " data-bs-parent="#sidebar-nav">
              <li>
                <a href="/users">
                  <i className="bi bi-circle"></i><span>All</span>
                </a>
              </li>
              <li>
